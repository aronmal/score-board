...
function New() {
  ...
  const removePlayer = (theButton: any) => {
    let match = players.findIndex((e) => e.uuid === theButton.target.parentElement.parentElement.id)
  ...
  const removeTeam = (theButton: any) => {
    let match = teams.findIndex((e) => e.uuid === theButton.target.parentElement.parentElement.parentElement.id)
    console.log(match)
