...
function Nav() {
  ...
  return (
    <nav id="nav" className='flex-row'>
      ...
      <Link className={`navlink ${(location.pathname === '/register') ? 'active' : ''}`} to='/register'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path className='svg-navlink' d="M24 10h-10v-10h-4v10h-10v4h10v10h4v-10h10z"/></svg><p>Registrieren</p></Link>
