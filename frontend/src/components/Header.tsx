...
function Nav() {
  ...
  return (
    <nav id="nav" className='flex-row'>
      ...
      :
      <Link className='navlink' to='/login'><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path className='svg-navlink' d="M13 2v-2l10 3v18l-10 3v-2h-9v-7h1v6h8v-18h-8v7h-1v-8h9zm-2.947 10l-3.293-3.293.707-.707 4.5 4.5-4.5 4.5-.707-.707 3.293-3.293h-9.053v-1h9.053z"/></svg><p>Logout</p></Link>
      }
    </nav>
  );
}
